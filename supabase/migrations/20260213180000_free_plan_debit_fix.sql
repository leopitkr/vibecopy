-- Free plan: do not require credit_balance; only enforce daily count (3/day).
-- UI shows "remaining" as 3 - today_debits via /api/me; debit only inserts ledger for free.
